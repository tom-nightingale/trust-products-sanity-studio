...
var DialogConfirm = function (props) {
    ...
    return (react_1.default.createElement(ui_1.Dialog, { footer: react_1.default.createElement(Footer, null), header: react_1.default.createElement(Header, null), id: "confirm", onClose: handleClose, width: 1, zOffset: constants_1.Z_INDEX_DIALOG },
