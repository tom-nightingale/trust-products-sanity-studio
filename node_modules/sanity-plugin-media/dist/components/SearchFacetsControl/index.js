...
var SearchFacetsControl = function () {
    ...
    var filteredFacets = constants_1.FACETS.filter(function (facet) {
    ...
    var remainingSearchFacets = filteredFacets.filter(function (facet) { return facet; }).length - searchFacets.length > 0;
    var renderMenuFacets = function (facets) {
        return (react_1.default.createElement(react_1.default.Fragment, null, facets === null || facets === void 0 ? void 0 : facets.map(function (facet, index) {
            ...
            if (facet.type === 'group') {
                return react_1.default.createElement(ui_1.MenuGroup, { title: facet.title }, renderMenuFacets(facet.facets));
            }
            if (facet) {
    ...
    return (react_1.default.createElement(ui_1.Flex, null,
        react_1.default.createElement(ui_1.MenuButton, { button: react_1.default.createElement(ui_1.Button, { disabled: !remainingSearchFacets, fontSize: 1, icon: icons_1.AddCircleIcon, mode: "bleed", text: "Add filter", tone: "primary" }), id: "facets", menu: react_1.default.createElement(ui_1.Menu, null, renderMenuFacets(filteredFacets)), placement: "right-start" }),
