...
var FormFieldInputTags = function (props) {
    ...
    , { 
        ...
        react_1.default.createElement(react_hook_form_1.Controller, { control: control, defaultValue: value, name: name, render: function (_a) {
                ...
                return (react_1.default.createElement(creatable_1.default, { cacheOptions: false, components: creatable_2.reactSelectComponents, defaultOptions: true, instanceId: "tags", isClearable: false, isDisabled: creating || disabled, isLoading: creating, isMulti: true, name: name, noOptionsMessage: function () { return 'No tags'; }, onBlur: onBlur, onChange: onChange, onCreateOption: onCreateTag, options: options, placeholder: placeholder, styles: creatable_2.reactSelectStyles, value: controllerValue }));
            } })));
};
