...
exports.reactSelectStyles = {
    control: function (styles, _a) {
        ...
        return __assign(__assign({}, styles), { background: isDisabled
                ...
                : 'transparent', color: 'white', border: 'none', borderRadius: themeRadius[2], boxShadow: boxShadow, minHeight: '35px', outline: 'none', transition: 'none', '&:hover': {
    ...
    menuList: function (styles) { return (__assign(__assign({}, styles), { maxHeight: '230px' })); },
    ...
    multiValueRemove: function (styles) { return (__assign(__assign({}, styles), { '&:hover': {
            background: 'transparent',
            color: 'inherit'
        } })); },
    option: function (styles, _a) {
        var isFocused = _a.isFocused;
        return (__assign(__assign({}, styles), { backgroundColor: isFocused ? themeDarkPrimaryBlue : 'transparent', borderRadius: themeRadius[2], color: isFocused ? color_1.black.hex : 'inherit', padding: '4px 6px', '&:hover': {
    ...
    valueContainer: function (styles) { return (__assign(__assign({}, styles), { marginBottom: themeSpace[1], marginLeft: themeSpace[1], marginTop: themeSpace[1], padding: 0 })); }
};
...
var MenuList = function (props) {
    return (react_1.default.createElement(react_select_1.components.MenuList, __assign({}, props, { className: "media__custom-scrollbar media__react-select__menu-list" }), props.children));
};
var MultiValueLabel = function (props) {
    return (react_1.default.createElement(ui_1.Box, { paddingLeft: 1, paddingRight: 0, paddingY: 1 },
        react_1.default.createElement(ui_1.Text, { size: 2, weight: "semibold" },
...
var Option = function (props) {
    return (react_1.default.createElement(ui_1.Box, { paddingX: 2, paddingY: 1 },
