...
exports.reactSelectStyles = {
    ...
    menuList: function (styles) { return (__assign(__assign({}, styles), { maxHeight: '146px', padding: 0 })); },
...
var MenuList = function (props) {
    return (react_1.default.createElement(react_select_1.components.MenuList, __assign({}, props, { className: "media__custom-scrollbar" }), props.children));
};
