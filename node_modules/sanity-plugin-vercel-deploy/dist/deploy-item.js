...
var deployItem = function deployItem(_ref) {
  var _deploymentData$deplo, _deploymentData$deplo2;
  ...
  var _useSWR = (0, _swr["default"])(["https://api.vercel.com/v1/projects/".concat(vercelProject).concat(vercelTeam !== null && vercelTeam !== void 0 && vercelTeam.id ? "?teamId=".concat(vercelTeam === null || vercelTeam === void 0 ? void 0 : vercelTeam.id) : ''), vercelToken], function (url, token) {
  ...
  var onCancel = function onCancel(id, token) {
    ...
    _axios["default"].patch("https://api.vercel.com/v12/now/deployments/".concat(id, "/cancel"), null, {
      headers: {
        'content-type': 'application/json',
        Authorization: "Bearer ".concat(token)
      }
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
  ...
  }, /*#__PURE__*/_react["default"].createElement("span", null, name), /*#__PURE__*/_react["default"].createElement(_ui.Badge, null, vercelProject), (vercelTeam === null || vercelTeam === void 0 ? void 0 : vercelTeam.id) && /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, ' ', /*#__PURE__*/_react["default"].createElement(_ui.Badge, {
    tone: "primary"
    ...
    header: "Deployment History: ".concat(name, " (").concat(deploymentData === null || deploymentData === void 0 ? void 0 : (_deploymentData$deplo = deploymentData.deployments[0]) === null || _deploymentData$deplo === void 0 ? void 0 : _deploymentData$deplo.meta.deployHookName, ")"),
    ...
    hookContext: deploymentData === null || deploymentData === void 0 ? void 0 : (_deploymentData$deplo2 = deploymentData.deployments[0]) === null || _deploymentData$deplo2 === void 0 ? void 0 : _deploymentData$deplo2.meta.deployHookName
  }))));
};
