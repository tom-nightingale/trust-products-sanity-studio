...
var Dropdown = function Dropdown(_ref) {
  ...
  }, selectedItem), dropdown ? React.createElement("ul", null, availableItems.map(function (item, index) {
...
var Menu = function Menu(_ref) {
  ...
  var _useState2 = useState(selectedDevice),
      device = _useState2[0],
      setDevice = _useState2[1];

  var _useState3 = useState(selectedDevice.colors),
  ...
  }), availableColors && React.createElement(Dropdown, {
...
var MobileDevicePreview = function MobileDevicePreview(_ref) {
  ...
  var _useState2 = useState('black'),
      selectedColor = _useState2[0],
      setSelectedColor = _useState2[1];

  var _useState3 = useState(preSelectedLandscape),
  ...
  return selectedDevice ? React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, showMenu && React.createElement(Menu, {
  ...
  }), React.createElement(BuildDevice, {
    selectedDevice: selectedDevice,
    selectedColor: selectedColor,
    landscape: landscape
  }, children)) : React.createElement("div", null, "Something strange happened");
};
